...
@Component
@AllArgsConstructor
public class JpaAnimaleslmpl implements AnimalesRepository {
    ...
    public Animales update(String nombre, Animales animales) throws Exception {
        ...
        if (animalesDb == null) throw new Exception("Animal " + nombre+" no encontrado");

        animalesDb.setGenero(animales.getGenero());
        animalesDb.setNumpatas(animales.getNumpatas());
